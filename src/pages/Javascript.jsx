      ...
      <ol>
        ...
        <li>
          ...
          <p>
            ...
            your whole program. Let will only be able to use within scope where
            you declare that and const is a variable that can never change.
          </p>
          <p>
          ...
          <p>
            <code>
              var b=2; By using = assignment operator we can assign variable to
              a value.
            </code>
          </p>
          <p>
          ...
          <p>
            <code>var a=9;</code>
            In this we are declaring and initializing variable at the same time.
            var a is declaring it and by using assignment operator = we are
        ...
        <li>
          ...
          <p>
            ...
            example. start a variable name with small letters and when you have
            new work use capital letter
          </p>
        ...
        <li>
          ...
          <p>
            Strings are immutable,meaning they cannot be altered once created.It
            does not mean it cannot be changed, just that the individual
        ...
        <li>
          ...
          <p>
            shift() is similar as pop() except shift() removes the first element
            of the array instead of the final element.
          </p>
          <p>
            <code>var ourArray=["Stimpson","J",["cat"]];</code>
          </p>
        ...
        <li>
          ...
          <p>
            It is similar to the push(), while push() adds an element at the end
            of the array, unshift() adds an element to the beginning of the
            array.
          </p>
          <p>
            <code>var ourArray=["Stimpson","J",["cat"]];</code>
        ...
        <li>
          ...
          <p>
            Anything inside the curly bracket will learn every time function is
            called.
          </p>
          <p>
            <code>
        ...
        <li>
          ...
          <p>
            Scope refers to the visibility of the variables.Variables which are
            defined outside of a function have a global scope. Global scope
            means they can be seen everywhere is your JavaScript scope.
          </p>
          <p>
        ...
        <li>
          ...
          <p>
            If we don't specify the return value then return value is undefined.
          </p>
        </li>
        ...
        <li>
          ...
          <p>
            This is a sign of equality operator. By val==12 we are not declaring
            that value is equals to 12 it is checking if val is 12 or not. this
            equality operator converts the type for example it will convert a
            string to a number.There is also a{" "}
        ...
        <li>
          ...
          <p>
            Above example explains that both the statements in the if statement
            have to be true otherwise answer will be No.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>Objects:</p>
          <p>
            Objects are similar to arrays except instead of using indexes access
          ...
          <p>
            Bracket notation also can be used to look up object properties using
            variables.
          </p>
          <p>
            <code>var ourDog=&#123;</code>
