    ...
    <div className="learning-css">
      ...
      <section class="columns">
        ...
        <p>
          ...
          attributes, or their relationship with other elements. Selectors help
          apply styles selectively to specific parts of a web page.
        </p>
        <p class="quote">
          &#8220;Where's my food, man? &#8221;{" "}
        ...
        <p>
          ...
          properties like length and width. Common units include pixels (`px`),
          percentage (`%`), em (based on font size), rem (based on root font
          size), and viewport units (`vw` and `vh`). Absolute units like
          centimeters, millimeters, inches, points, and picas are also used for
          specific scenarios.
        </p>
        <p>
          Box Model: The CSS box model is a fundamental concept that defines the
          layout of elements on a web page. It consists of four main components:
        </p>
        <ol>
          ...
          <li>
            Margin: - The space between the border and the neighboring elements.
          </li>
        </ol>
      ...
      <p>
        Typography: In CSS, typography refers to styling and formatting text on
