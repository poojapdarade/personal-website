export function LearningHtml() {
  return (
    <div className="leanringhtml">
      ...
      <p>
        I am learning about Git and here I am documenting my progress. As a part
        of learning I am using Git while making my website.
      </p>
      ...
      <p>
        ...
        include these changes in the next commit. Staging changes allows you to
        selectively choose which modifications should be part of the next
      ...
      <p>
        ...
        current state of your repository. When executed, it displays information
        about any changes in your working directory compared to the last
        committed version. This includes untracked files, modifications to
        tracked files, and files that are staged for the next commit. git status
        is a valuable tool for understanding the status of your project, helping
        you keep track of changes, and guiding you on what actions are needed,
        such as committing changes or adding files to the staging area. It
        provides a snapshot of the repository's status, allowing you to make
        informed decisions about the next steps in your version control
        workflow. For example, if you have added a file to git by using git add
        ''file_name'' and also do a git commit when you do git status it will
        show a message ''branch is one ahead'' of origin
      </p>
      <h2>
        <code>git push</code>
      </h2>
      <p>
        The git push command is used in Git to upload the committed changes from
        your local repository to a remote repository. It enables you to
        synchronize your work with a shared or central repository, making your
        changes accessible to others collaborating on the project. By specifying
        the remote repository and branch you want to push to, such as git push
        origin master, you update the corresponding branch on the remote with
        your local commits, ensuring that both repositories are in sync and
        reflecting the latest state of the project.
      </p>
      <h2>
        <code>git commit</code>
      </h2>
      <p>
        ...
        remote repository into your local working branch. When you run git pull,
        it automatically combines the git fetch command, which retrieves the
        latest changes from the remote repository, with the git merge command,
        which incorporates those changes into your local branch. This ensures
        that your local copy is updated with the most recent modifications from
        the remote repository, providing a seamless way to keep your local
        branch in sync with the collaborative development happening in the
        shared repository.
      </p>
      <h2>
        <code>git clone</code>
      ...
      <p>
        ...
        complete and independent working copy that you can modify and contribute
        to while maintaining a link to the original repository for updates.
      </p>
      <h2>
        <code>git log</code>
      </h2>
      ...
      <p>
        ...
        use
        <code>git checkout -b branch_name</code> command to create and jump to a
        new branch.
      </p>
      <h2>
        <code>git merge</code>
